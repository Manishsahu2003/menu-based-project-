...
# Page Config
st.set_page_config(page_title="Linux World Summer Internship - Final Project Dashboard", layout="wide")
...
def setup_gemini():
    api_key = "AIzaSyD5G58h5snx2FPUntIvbNphuFV1WUsTySI"
...
# Header
st.title("Linux World Summer Internship - Final Project Dashboard")
st.markdown("**Multi-Tool Dashboard by Manish Sahu**")
st.markdown("---")
...
if selected == "Ultimate Multi-Tool Dashboard" or selected == "Home":
    ...
    st.write("Linux World Summer Internship Final Project")
...
elif selected == "AI Assistants":
    st.header("AI Assistants")
    
    try:
        model = setup_gemini()
        assistant = st.selectbox("Select AI Assistant", ["AWS Helper", "DevOps Mentor", "Code Solver"])
    ...
    <body>
      ...
      <div class="section">
        ...
        <button onclick="stopRecording()">⏹️ Stop & Save Video</button><br><br>
        <video id="recordedVideo" controls></video><br>
        <a id="downloadVideoLink" style="display:none;" download="recorded_video.webm">⬇️ Download Video</a>
      </div>
      ...
      <div class="section">
        ...
        <p id="locationText"></p>
        <a id="mapLink" href="#" target="_blank" style="display:none;">🗺️ View on Map</a><br><br>
        <button onclick="viewNearbyStores()">🛒 View Nearby Grocery Stores</button>
        <a id="groceryLink" href="#" target="_blank" style="display:none;">🛍️ Open Grocery Stores Map</a>
      </div>
      ...
      <div class="section">
        ...
        <form onsubmit="sendEmail(); return false;">
          ...
          <button type="submit">✉️ Send Email</button>
        </form>
      </div>
      ...
      <script>
        ...
        function capturePhoto() {
          ...
          downloadLink.textContent = "⬇️ Download this image";
    ...
    uploaded_file = st.file_uploader("Upload your CSV file (m.csv)", type=['csv'])
    ...
    portfolio_url = "https://msahu.netlify.app"
    
    if st.button("Open My Portfolio"):
        st.markdown(f"[Click here to view portfolio]({portfolio_url})")
        st.success("Portfolio link is ready to open")
        
    st.write("**Portfolio URL:** https://msahu.netlify.app")
    st.write("**Created by:** Manish Sahu")
    st.write("**Role:** DevOps Engineer")
    st.write("**Location:** Udaipur, India")
...
# Footer
st.markdown("---")
st.markdown("### Linux World Summer Internship - Final Project Dashboard")
st.markdown("**Student:** Manish Sahu | **Project:** Multi-Tool Automation Dashboard")
import streamlit as st

def render_devops_section():
    st.title(" DevOps Projects")
    st.markdown("Explore my DevOps projects using Jenkins, Kubernetes, and CI/CD pipelines.")

    st.subheader("🔧 Select a Project to View")

    # Create project buttons in a neat layout
    col1, col2, col3 = st.columns(3)

    with col1:
        st.markdown("""
            <a href="https://github.com/Manishsahu2003/triyal" target="_blank">
                <button style='padding:10px 15px; font-size:14px; background-color:#1f77b4; color:white; border:none; border-radius:5px; cursor:pointer;'>
                    Jenkins CI/CD
                </button>
            </a>
        """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
            <a href="https://github.com/Manishsahu2003/Kubernetes-Cluster-Management" target="_blank">
                <button style='padding:10px 15px; font-size:14px; background-color:#2ca02c; color:white; border:none; border-radius:5px; cursor:pointer;'>
                    Kubernetes Cluster
                </button>
            </a>
        """, unsafe_allow_html=True)
    ...
    with col3:
        st.markdown("""
            <a href="https://github.com/Manishsahu2003/kubernatives" target="_blank">
                <button style='padding:10px 15px; font-size:14px; background-color:#ff7f0e; color:white; border:none; border-radius:5px; cursor:pointer;'>
                    Kubernatives Project
                </button>
            </a>
        """, unsafe_allow_html=True)

# Call this function inside your app when the DevOps section is selected
if __name__ == "__main__":
    render_devops_section()
